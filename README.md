...
The study can be found [here](/data_analyses/l5_v_total.ipynb).
...
The study can be found [here](/data_analyses/xg_vs_g.ipynb).
...
The study can be found [here](/data_analyses/prev_vs_ytd.ipynb).
